...
class Bunker(Scene):
    def enter(self):
        ...
        The loud speaker on the ship is loud but you can tell the tenseness in his voice. You grumble awake and 
        remember your surroundings. Looking around you see the many crates of cargo. In fact you are sleeping up against one of these crates. 
        You have a blanket and some sort of sack that you are resting your head on. You are still groggy and hear the intercom again.
...
class Hull(Scene):
    def enter(self):
        print(dedent("""
        Running up the stairs to the hull you look out the windows of the ship. It's very large and almost mesmerizing. Almost. Once you notice 
        all of the blaster cannon shots being fired and ships surrounding this large cargo ship your mood changes
        ...
        After getting back up to your feer you can see who is calling your name. It's the captain of the ship. You can tell by the uniform he has on and the 
        cap that he is wearing with a special holographic signia.

        "Get the hell over here you liar"

        Instantly your mind starts to grow weary. How did he know that I was lying? My story was pretty well told and there were no loop holes. I am just a hitchiker trying to get to 
        get anywhere in the Delta Quadrent. No other motives. No other information. 

        "You aren't who you say you are lad"
        you respond
        "What do you mean" 
        The whole time you are both yelling over the loud blasts hitting the ships and the crew yelling at eachother to make sure the ship kept running
        ...
        Laxian yelled "They jammed our comms and sent a message saying if we don't give up a hitch hiker aboard this ship there would be consequences! I 
        tried to cover your ass like a fool and now I don't think we are going to get out of here alive if you continue to stay on board!"

        Well yeah now they know who I am. Shit. But how the hell did they know I was here. I left the research facility without a trace. All I had on me was the classified data in the 
        memory of my cybernetic implant. There is no way they could track me. 
        
        You yell "Alright well if it is that important I'm a wanted man by both the Galactic Overseers and the Milky Way Federation for information that could change the tide of the war!
        ...
        Struggling to say the words you respond "They just want me right? Is there any way you can eject me out of this ship to a planet near by. I'll get out of your hair and your 
        ship will survive" 

        The Captain releases his grip off of you slowly and ponders your proposal. 

        "The only way we could get you off of this ship is if you take one of the pods with some cargo to hide your escape. But we have to move fast otherwise we will both be dead"
...
class TheBridge(Scene):
    def enter(self):
        print(dedent("""
        Laxian grabs you by the arm in haste and pulls you towards the main bridge of the ship and tells you to look to the side of the ship through the window.
        ...
        Suddenly Sirens are going off within the ship and red lights are flashing. The robotic voice from before comes over calmly on the loud speaker.
        ...
        He directs you to follow him closely but to keep an eye out for intruders. The whole crew seems to be up in arms while still trying to maintain the ships vitals
        ...
        if option == 'run':
            ...
            about the horrible descison you just made.
...
class Pod(Scene):
    def enter(self):
        print(dedent("""
        You see a recon enemy ship attached to the side of the frieghter. Other crew members have come to you and the captains aid to clear the rest of the ship out. You here more blasts and more bodies his the ground.
        ...
        if option == 'shoot':
            ...
            You real back in pain and the Laxion takes a shot at him and he falls to the ground dead. Your arm is pretty injured but still usable for now. Adrenaline is one hell of a drug.
            ...
            "Here I'm going to have to put you in with some cargo to disguise it. Each container has an identifier chip on it so it should look like cargo has been launched and nothing important buying you some time"
...
class EscapeShip(Scene):
    def enter(self):
        print(dedent("""
        The pod detaches from the ouside hull of the ship and you take the controls and start manueving the ship down looking for the nearest planet to land. The onboard 
        ...
        if option == '1':
            ...
            There are ships flying all around still shooting at the freighter you have to manauver through all of this to enter this unknown planet

            the route to the right is near the hull of the freighter and is being heavily fired at and the route to your left is seemingly clear 
            ...
            #work on this one for later
                ...
                unaware of your presense as you fly down to the mysterious planet
                """)
                ...
                print(dedent("""
                    ...
                    you frantically make some inputs into the ship and make all the available shields go to he back of the ship just in time for a cannon shot 

                    BOOOOOM

                    sheilds are at half now if this little pod takes one more hit its down for the count

                    you take evasive manuavers and narrowly escape the second shot. The planet is closer now and you need to make sure you have enough protection for the entry. 
                ...
                if option == 'move shields to the front':
                    ...
                    you panick trying to manuever the ship to not crash straight into the woods. You veer upwards and try to avoid the trees but clip one and the ship starts crashing into the ground
                    and you blackout 
